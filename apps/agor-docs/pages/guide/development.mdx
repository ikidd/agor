...
- **[AGENTS.md](https://github.com/mistercrunch/agor/blob/main/AGENTS.md)** - Development patterns and project structure
- **[CONTRIBUTING.md](https://github.com/mistercrunch/agor/blob/main/CONTRIBUTING.md)** - Complete contribution guide
- **[context/README.md](https://github.com/mistercrunch/agor/blob/main/context/README.md)** - Architecture documentation index
- **[context/concepts/core.md](https://github.com/mistercrunch/agor/blob/main/context/concepts/core.md)** - Core primitives and design philosophy
...
Browse the **[roadmap issues](https://github.com/mistercrunch/agor/issues?q=is%3Aissue%20state%3Aopen%20label%3Aroadmap)** for contribution ideas, or propose your own!
